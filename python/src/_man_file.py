...
class ManFile:
    ...
    # ---------------------------------------------------------
    @classmethod
    def dir_path_openapi_spec(cls) -> str:
        """ abs dir path to 'cache' dir """
        return cls.full_path(rel_path="../kotlin/src/main/resources/openapi", root_path=cls.dir_path_root())
    ...
    # ---------------------------------------------------------
    @classmethod
    def file_path_openapi_spec(cls, file_name: str) -> str:
        """ full path of 'file_name' in cache dir  """
        return cls.full_path(root_path=cls.dir_path_openapi_spec(), rel_path=file_name)
